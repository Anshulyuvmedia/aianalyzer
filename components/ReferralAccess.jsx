...
const ReferralAccess = ({ referralData }) => {
  const [referralLink, setReferralLink] = useState(
    "https://one.exnesstrack.org/a/df1vcmxnjg"
  );
  const [emailInput, setEmailInput] = useState("");

  // Dynamically use the provided referralData
  ...
  const recentReferrals =
    referralData?.recentReferrals?.map((ref) => ({
      email: ref.email,
      date: ref.dateJoined,
      earnings: `$${ref.earnings.toFixed(2)}`,
      status: ref.status,
    })) || [];
          ...
          <View style={styles.content}>
            ...
            <View style={styles.earningsSummary}>
              ...
              <View style={styles.summaryRow}>
                ...
                <Text style={styles.summaryValue}>
                  {earningsSummary.commissionRate}
                </Text>
              </View>
            </View>
                ...
                <View key={index} style={styles.tableRow}>
                  ...
                  <Text
                    style={[
                      ...
                      {
                        backgroundColor:
                          referral.status === "Active" ? "#152a2d" : "#ef4444",
                        color: "#43c976",
                      },
                    ]}
                  >
